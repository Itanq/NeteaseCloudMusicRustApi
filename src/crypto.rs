...
impl Crypto {
    pub fn weapi(text: &str) -> String {
        ...
        let params = Crypto::aes_encrypt(
            &Crypto::aes_encrypt(text, preset_key, cbc, base64::encode),
    ...
    pub fn linuxapi(text: &str) -> String {
        let params = Crypto::aes_encrypt(
            text, linux_api_key, ecb, |t:&Vec<u8>| hex::encode(t)
        ).to_uppercase();
    ...
    pub fn aes_encrypt(data: &str, key: &str, mode: AesMode, encode: for<'r> fn(&'r Vec<u8>) -> String) -> String {
...
mod tests {
    ...
    fn test_aes_encrypt() {
        ...
        let res = Crypto::aes_encrypt(msg,  preset_key, AesMode::cbc, base64::encode);

        assert_eq!(res, "pgHP1O/hr+IboRMAq6HzpHjyYwNlv1x0G4BBjd1ohdM=");

        let res2 = Crypto::aes_encrypt(&res, key1, AesMode::cbc, base64::encode);
    ...
    fn test_hash_encrypt() {
        ...
        assert_eq!(Crypto::hash_encrypt(msg, HashType::md5, hex::encode), "1a72fd2483743c6b1af60041af3edd20");

        let pw = "email2158";

        assert_eq!(Crypto::hash_encrypt(pw, HashType::md5, hex::encode), "afafe22f87fb761d97b8897e00e98fac");
    }
